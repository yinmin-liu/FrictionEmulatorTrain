...
- `train.sh`: after filtering and splitting, select up to 30,000 training rows
...
- `train_uniform.sh`: after the same filtering and splitting, select up to 30,000 training rows
